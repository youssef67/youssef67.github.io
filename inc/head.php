      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav navbar-right">
          ...
          <li><a href="#">Gluten full</a></li>
            <li>
                <a href="/youssef/quetes_php_cookies_sessions-master/login.php" class="btn btn-warning navbar-btn" style ="margin-right: 2%;">
          ...
          <li>
            <a href="/youssef/quetes_php_cookies_sessions-master/cart.php" class="btn btn-warning navbar-btn">
